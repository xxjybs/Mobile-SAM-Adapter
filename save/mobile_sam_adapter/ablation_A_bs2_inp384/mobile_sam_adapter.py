...
from .sam_adapter.modeling.models import register

from .MobileSAMv2.mobilesamv2.build_sam import *
# from models.sam_adapter.modeling.mmseg.models.sam import ImageEncoderViT, MaskDecoder, TwoWayTransformer
from .cross_attention import EdgePromptBranch


logger = logging.getLogger(__name__)
from .sam_adapter.modeling.iou_loss import IOU
...
class Mobile_sam_adapter(nn.Module):
    def __init__(self, inp_size=1024):
        ...
        self.embed_dim = 1024
        self.image_encoder = build_sam_vit_t_encoder(img_size=inp_size)
